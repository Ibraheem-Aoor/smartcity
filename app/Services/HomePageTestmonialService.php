...
class HomePageTestmonialService extends BaseModelService
{
    public function __construct()
    {
        parent::__construct(new HomePageTestmonial());
    ...
    protected function getModelAttributes($request)
    {
        ...
        {
            $data['image'] = saveImage('home_page_testmonials' , $request->file('image'));
        }
