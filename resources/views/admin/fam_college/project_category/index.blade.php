            ...
            <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                <li class="breadcrumb-item text-capitalize">
                    <a class="btn btn-md btn-primary text-white m-1" data-bs-toggle="modal" data-bs-target="#{{ $modal }}"
                        ...
                        data-header-title= "{{ __('general.training.create_new_program_category') }}" data-image="{{ asset('assets/common/product-placeholder.webp') }}"
...
@push('js')
    ...
    <script src="{{ asset('assets/admin/js/custom/fam/program_category.js') }}"></script>
@endpush
