            ...
            <div class="p-4">
                <form action="{{ route($route . '.update') }}" method="POST" class="custom-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label">{{ __('general.instagram  ') }}<span class="text-danger">*</span></label>
                                <div class="form-icon position-relative">
                                    <input type="text" name="instagram" id="instagram" value="{{ @$settings['instagram'] }}" required class="form-control">
                                </div>
                            </div>
                        </div><!--end col-->
                        <div class="col-md-4">
