...
@section('content')
    @include('admin.partials.page_header', [
        ...
        'sub_pages' => [
            $title => route('admin.contacts.index'),
        ],
    ])
    {{-- Table Extra actions --}}
            ...
            <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                <li class="breadcrumb-item text-capitalize">
                    <a class="btn btn-md btn-primary text-white m-1" data-bs-toggle="modal" data-bs-target="#{{ $modal }}"
                        ...
                        data-header-title= "{{ __('general.business_and_innovation_ecosystem.create_new_consulting_service') }}" data-image="{{ asset('assets/common/product-placeholder.webp') }}"
...
@push('js')
    ...
    @else
        <script src="{{ asset('assets/admin/js/datatable-en.js') }}"></script>
    @endif
    <script src="https://cdn.datatables.net/2.0.0/js/dataTables.min.js"></script>
    <script src="{{ asset('assets/admin/js/custom/consulting_services.js') }}"></script>
@endpush
