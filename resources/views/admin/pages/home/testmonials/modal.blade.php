                ...
                <div class="modal-body">
                    <div class="p-3 rounded box-shadow">
                        <d class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('general.location') }}<span
                                            class="text-danger">*</span></label>
                                    <div class="form-icon position-relative">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('general.feedback') }}<span
                                            class="text-danger">*</span></label>
                                    <div class="form-icon position-relative">
                                        <textarea type="text" name="feedback" id="feedback" class="form-control" cols="30" rows="10"></textarea>
                                    </div>
                                </div>
                            </div><!--end col-->
                    </div>
