 ...
 <header id="topnav" class="defaultscroll sticky">
     <div class="container">
         ...
         <a class="logo" href="index.html">
             <img loading="lazy" src="{{ asset('assets/admin/images/logo-dark.png') }}" height="24"
                 class="logo-light-mode" alt="">
             <img loading="lazy" src="{{ asset('assets/admin/images/logo-light.png') }}" height="24"
         ...
         <ul class="buy-button list-inline mb-0">
             <li class="list-inline-item mb-0">
                 <a href="javascript:void(0)" class="btn btn-icon btn-light">
                     <img loading="lazy" src="{{ asset('assets/admin/images/app/app-store.png') }}"
             ...
             <li class="list-inline-item mb-0">
                 <a href="javascript:void(0)" class="btn btn-icon btn-light">
                     <img loading="lazy" src="{{ asset('assets/admin/images/app/play-store.png') }}"
                         class="avatar avatar-ex-small p-1" alt="">
                 </a>
             </li>
         </ul>
                             ...
                             <ul>
                                     ...
                                     <a href="index-corporate.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/corporate.png') }}"
                                 ...
                                 <li>
                                     <a href="index-crypto.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/crypto.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                                 ...
                                 <li>
                                     <a href="index-real-estate.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/real.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                             ...
                             <ul>
                                 <li>
                                     <a href="index-shop.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/shop.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                                 ...
                                 <li>
                                     <a href="index-portfolio.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/portfolio.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                                 ...
                                 <li>
                                     <a href="index-photography.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/photography.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                             ...
                             <ul>
                                 <li>
                                     <a href="helpcenter-overview.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/help-center.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                                 ...
                                 <li>
                                     <a href="index-hosting.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/hosting.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                                 ...
                                 <li>
                                     <a href="index-video-studio.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/video-studio.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                             ...
                             <ul>
                                 <li>
                                     <a href="index-job.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/job.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                                 ...
                                 <li>
                                     <a href="forums.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/forums.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                             ...
                             <ul>
                                 <li>
                                     <a href="index-blog.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/blog.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
                                 ...
                                 <li>
                                     <a href="index-nft.html" class="sub-menu-item">
                                         <div class="text-lg-center">
                                             <span class="d-none d-lg-block"><img loading="lazy"
                                                     src="{{ asset('assets/admin/images/demos/nft.png') }}"
                                                     class="img-fluid rounded shadow-md" alt=""></span>
