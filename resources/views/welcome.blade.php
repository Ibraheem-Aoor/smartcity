        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-5">
                <div class="h-100" style="border: 50px solid; border-color: transparent #13357B transparent #13357B;">
                    <img src="https://img.freepik.com/free-photo/innovative-futuristic-classroom-students_23-2150906268.jpg?t=st=1722887072~exp=1722890672~hmac=2e6182b04e179cff4f9b554791674e8173a1f1d99eb16f86a5414c0a4e240fdf&w=740"
                        class="img-fluid w-100 h-100" alt="">
                </div>
            </div>
            <div class="col-lg-7"
                style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url({{ asset('assets/site/img/about-img-1.png') }});">
                <h5 class="section-about-title pe-3">About Us</h5>
                <h1 class="mb-4">Welcome to <span class="text-primary">Academic Smart City</span></h1>
                <p class="mb-4">Academic Smart City is an innovative initiative designed to bring together various
                    educational, professional, and entrepreneurial resources into a single, integrated ecosystem. We aim
                    to foster learning, development, and growth across multiple domains through a comprehensive suite of
                    services and facilities.</p>
                <p class="mb-4">Our platform includes specialized consultations, advanced training programs,
                    international and local university hubs, state-of-the-art academic venues, incubators for
                    entrepreneurial projects, and a dedicated freelancing arena. Our mission is to create a dynamic and
                    supportive environment that caters to the evolving needs of students, professionals, and
                    entrepreneurs alike.</p>
                <div class="row gy-2 gx-4 mb-4">
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Smart Consultations</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Graduate School for
                            Business & Entrepreneurship</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Smart Training and
                            Development</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Smart International
                            Universities Hub</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Smart Local Universities
                            Hub</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Academic Venues</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Smart Incubators</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Remote Freelancing Arena
                        </p>
                    </div>
                </div>
        ...
        <div class="packages-carousel owl-carousel">
            <div class="packages-item">
                <div class="packages-img">
                    <img src="{{ asset('assets/site/img/packages-4.jpg') }}" class="img-fluid w-100 rounded-top"
                        alt="Image">
            ...
            <div class="packages-item">
                <div class="packages-img">
                    <img src="{{ asset('assets/site/img/packages-2.jpg') }}" class="img-fluid w-100 rounded-top"
                        alt="Image">
                    <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                        style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                        <small class="flex-fill text-center border-end py-2"><i
            ...
            <div class="packages-item">
                <div class="packages-img">
                    <img src="{{ asset('assets/site/img/packages-3.jpg') }}" class="img-fluid w-100 rounded-top"
                        alt="Image">
                    <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                        style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                        <small class="flex-fill text-center border-end py-2"><i
            ...
            <div class="packages-item">
                <div class="packages-img">
                    <img src="{{ asset('assets/site/img/packages-1.jpg') }}" class="img-fluid w-100 rounded-top"
                        alt="Image">
                    <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                        style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                        <small class="flex-fill text-center border-end py-2"><i
        ...
        <div class="row g-4">
                ...
                <div class="guide-item">
                    <div class="guide-img">
                        <div class="guide-img-efects">
                            <img src="{{ asset('assets/site/img/guide-1.jpg') }}"
            ...
            <div class="col-md-6 col-lg-3">
                <div class="guide-item">
                    <div class="guide-img">
                        <div class="guide-img-efects">
                            <img src="{{ asset('assets/site/img/guide-2.jpg') }}"
                                class="img-fluid w-100 rounded-top" alt="Image">
                        </div>
                        <div class="guide-icon rounded-pill p-2">
                            <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i
            ...
            <div class="col-md-6 col-lg-3">
                <div class="guide-item">
                    <div class="guide-img">
                        <div class="guide-img-efects">
                            <img src="{{ asset('assets/site/img/guide-3.jpg') }}"
                                class="img-fluid w-100 rounded-top" alt="Image">
                        </div>
                        <div class="guide-icon rounded-pill p-2">
                            <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i
            ...
            <div class="col-md-6 col-lg-3">
                <div class="guide-item">
                    <div class="guide-img">
                        <div class="guide-img-efects">
                            <img src="{{ asset('assets/site/img/guide-4.jpg') }}"
                                class="img-fluid w-100 rounded-top" alt="Image">
                        </div>
                        <div class="guide-icon rounded-pill p-2">
                            <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i
